...
- (void)drawRect:(CGRect)rect {
    ...
    if ([[[NSUserDefaults standardUserDefaults]valueForKey:@"isSurvey"] isEqualToString:@"YES"]) {
        request = [[NSFetchRequest alloc] initWithEntityName:@"SurveyList"];
    }else{
        request = [[NSFetchRequest alloc] initWithEntityName:@"FormsList"];
    }
    ...
    [_tblFormsInProgress setFrame:CGRectMake(_tblFormsInProgress.frame.origin.x, _tblFormsInProgress.frame.origin.y, _tblFormsInProgress.frame.size.width,(70.0f*([arrOfForms count])))];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
   ...
   // labelText.backgroundColor=[UIColor yellowColor];
    ...
    labelTime = [[UILabel alloc]initWithFrame:CGRectMake(81,labelText.frame.size.height + 18,200,20)];
