...
#define DEFAULT_TILEWIDTH 36
#define DEFAULT_TILEHEIGHT 36
...
//    return;
    ...
    else 
    {
        ...
        floatArray = (CGFloat *) malloc(sizeof(float) * [c count]);
...
//    Note this will allow to change graph background color.
//    CGRect rect = CGRectMake(leftMargin, topMargin, _gridWidth, _gridHeight+topMargin);
//    CGContextSaveGState(ctx);
//    
