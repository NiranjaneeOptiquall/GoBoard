...
#3 Draw circle at ploating pint can be handle by _drawAnchorPoints of same class
...
//    NSArray *atemparr = [self subviews];
//    for (UIView *viewTemp in atemparr) {
//        [viewTemp setBackgroundColor:[UIColor yellowColor]];
//        [viewTemp.layer setBackgroundColor:[UIColor greenColor].CGColor];
//    }
}
